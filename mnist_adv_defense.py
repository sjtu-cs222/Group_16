...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
  ...
  model_defense = cnn_model(img_rows=img_rows, img_cols=img_cols,
                    channels=nchannels, nb_filters=64,
                    nb_classes=nb_classes)
...
#        assert X_test.shape[0] == test_end - test_start, X_test.shape
  ...
  # Evaluate the accuracy of the MNIST model on legitimate test examples
    eval_params = {'batch_size': batch_size}
    acc = model_eval(sess, x, y, preds_defense, x_test_defense, y_test, args=eval_params)
    print('Test accuracy on legitimate examples: %0.4f' % acc)
  ...
  train(sess, loss_defense, x_train_defense, y_train, evaluate=evaluate_defense,
        args=train_params_defense, rng=rng)
  ...
  acc = model_eval(sess, x, y, preds_adv_defense, x_test, y_test, args=eval_par)
  print('Test accuracy on adversarial examples: %0.4f\n' % acc)
